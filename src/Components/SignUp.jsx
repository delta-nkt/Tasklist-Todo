...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-500 via-indigo-400 to-blue-400">
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-4xl">
        {/* Card on the left */}
        <div className="w-full max-w-md bg-white/90 p-10 rounded-3xl shadow-2xl flex flex-col items-center">
          <h2 className="text-4xl font-extrabold mb-6 text-center text-indigo-700 drop-shadow">Sign Up</h2>
